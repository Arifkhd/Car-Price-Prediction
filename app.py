...
def main():
    ...
    if Name == 'None':
        st.warning("Please select valid Name from the dropdown.")
    else:
    ...
    Seller_Type = st.selectbox('Seller Type',('None','Individual','Dealer'))
    if Seller_Type == 'None':
    ...
    if Transmission == 'None':
        st.warning('Please enter valid transmission type')
    else:
        st.success(f'You selected: {Transmission}')
        
    Owner_Type = st.selectbox('Owner Type',('None','First Owner','Second Owner','Third Owner','Fourth & Above'))
    if Owner_Type == "None":
        st.warning("Please enter valid owner type.")
    else:
